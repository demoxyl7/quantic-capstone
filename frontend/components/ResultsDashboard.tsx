    ...
    <div className="space-y-6 animate-fade-in-up">
        ...
        <div className="surface-elevated p-6 flex flex-col sm:flex-row gap-6 items-center">
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed max-w-xl">
              {data.score >= 75
                ? "Your profile aligns well with this role. As your advisor, I've identified a few key areas where we can sharpen your edge."
                : data.score >= 50
                  ? "There's a solid foundation here. Focus on addressing these specific skill gaps I've identified to move your application to the top of the pile."
                  : "The gap between your current profile and this role is significant. I've outlined the most critical learning paths to bridge this divide."}
            </p>
          </div>
        </div>
      )}
      ...
      {(showSkills || showLearningPath) && (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          {/* Learning Path */}
          {showLearningPath && (
            <div className={`surface-elevated p-5 ${!showSkills ? 'md:col-span-2 lg:col-span-3' : 'md:col-span-2 lg:col-span-1'}`}>
              <div className="flex items-center gap-2 mb-4">
